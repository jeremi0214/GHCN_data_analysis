...
This repository contains a Spark-based Jupyter notebook for analyzing the **Global Historical Climatology Network daily (GHCNd)** dataset. The work forms part of **Assignment 1** for the University of Canterbury’s *DATA420: Data Engineering* course.
...
4. Clone this repository or upload the notebook:
   ```bash
   git clone https://github.com/yourusername/ghcnd-spark-assignment.git
